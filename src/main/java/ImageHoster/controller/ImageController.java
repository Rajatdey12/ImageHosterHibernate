...
public class ImageController {
    ...
    public String showImage(@PathVariable(name = "imageId") Integer imageId, @PathVariable(name = "title") String title, Integer userId, Model model) {
        Image image = imageService.getImageItem(imageId, title);
        model.addAttribute("image", image);
        model.addAttribute("tags", image.getTags());
        List<Comment> comments = commentService.getAllComments(imageId, userId);
